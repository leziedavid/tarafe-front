...
export default function Hero() {
    return (
        <>
            ...
            <section className="relative w-full max-w-7xl mx-auto px-3 md:px-6 py-4 sm:py-6">
                {/* Conteneur principal */}
                <div className="relative w-full h-[280px] sm:h-[380px] md:h-[520px] lg:h-[600px] rounded-2xl sm:rounded-3xl overflow-hidden">
                    {/* Image de fond */}
                    ...
                    <div className="relative h-full flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:p-12 overflow-hidden">
                        ...
                        <div className="flex justify-between items-start">
                            ...
                            {/* Badge optionnel */}
                            <span className="px-2 py-1 sm:px-3 sm:py-1  bg-[#fd980e] text-white text-xs  rounded-full font-semibold backdrop-blur-sm  whitespace-nowrap flex-shrink-0 ">
                                Nouvelle Collection
                            </span>
                        </div>

                        {/* Contenu principal - Centre vertical */}
                        <div className=" flex-1 flex flex-col justify-center  max-w-full md:max-w-xl space-y-3 sm:space-y-4 md:space-y-6 mt-4 sm:mt-0 ">
                            {/* Titre ajusté */}
                            ...
                            {/* Description ajustée */}
                            <p className="text-white/90 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed max-w-[280px] sm:max-w-md md:max-w-lg break-words whitespace-normal backdrop-blur-sm bg-black/20 p-2 sm:p-3 rounded-lg line-clamp-3 sm:line-clamp-none">
                            ...
                            <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 pt-1 sm:pt-2">
                                <button className=" group relative  px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 bg-gradient-to-r from-[#fd980e] to-[#ffb24d]  text-white font-semibold rounded-full hover:shadow-lg hover:shadow-[#fd980e]/30  transition-all duration-300 hover:scale-105  text-xs sm:text-sm md:text-base  whitespace-nowrap ">
                                ...
                                <button className=" group  px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3  border border-white text-white font-semibold  rounded-full backdrop-blur-sm bg-white/10  hover:bg-white hover:text-[#242078]  transition-all duration-300 hover:scale-105  text-xs sm:text-sm md:text-base  whitespace-nowrap "  >
                                    En savoir plus
                                </button>
                            </div>
                        </div>
